...
function ss_open_sub(){
  ...
  ss_url_p1          = "fd3332f9"
  ss_url_p2          = "e0c135c8d15526884db45558e53a4434c167ca3ebd8129919141448b4db44a04a078182281548866e2c02b9594017b"
  ss_url_p3          = "aeae1ecd6d98917343aa1309b6905f39f2f7b331"
...
function writeFlash() {
  ...
  var str =
    ...
    "<PARAM NAME='flashVars' VALUE='timeText=01:34:16(JST)'>" +
    "<PARAM NAME='wmode' VALUE='transparent'>" +    
    "<EMBED src='" + ss_flashLocation + "' FlashVars='timeText=01:34:16(JST)'" +
    " WIDTH='" + ss_width + "'" +
    " HEIGHT='" + ss_height + "'" +
    " NAME='ss_imgTag'" +
